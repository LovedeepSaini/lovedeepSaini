        ...
        $.ajax({
            ...
            success: function(results) {
                ...
                if (results.data.dept == 0){
                    ...
                    $("#delLocConfirm").hide();
                    let text = document.getElementById("delmessage").innerHTML = "Location cannot be deleted. It consists of "+ results.data.dept  + " departments.";
                }
