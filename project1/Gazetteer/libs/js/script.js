...
//Popup with content
    var fontsizesmall = 1;
    popup.setContent("<b>Weatherdata</b>:<br>" + "<img src=" + weathercondtioniconhtml + "><br>" + weatherconditionstring + "<br><b>Weather Condition:</b>" + weatherconditiondescription + "<br><b>Temperature:</b> " + temperaturecelsius + "°C<br><b>Country:</b>" +weather_country+ " <br><b>Humidity: </b>" + airhumidity + "%" + "<br><b>Cloudcoverage:</b> " + cloudcoverage + "%<br><b>Windspeed:</b> " + windspeedkmh + " km/h<br><br><br><font size=" + fontsizesmall );           
